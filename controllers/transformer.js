...
exports.getTransformers = asyncHandler(async(req, res, next) => {
    ...
    let select = queries.select === "" ? "" : queries.select
...
exports.getTransformer = asyncHandler(async(req, res, next) => {
    const transformer = await Transformer.findOne({code: req.params.id}).select("-_id")
...
exports.transformerImageUpload = asyncHandler(async(req, res, next) => {
    ...
    const transformer = await Transformer.findOne({code: req.params.codeId})
